...
class BibManagerFieldsList {
	...
	public static function getTypeDefinitions(): array {
		// TODO RBV (23.12.11 13:36): Make arrays global (label sould be only the language key!)
		// Iterate over them, i18n-ify lables and run hook.
		$typeDefinitions = [
			'article' => [
		...
		MediaWikiServices::getInstance()->getHookContainer()->run( 'BibManagerGetTypeDefinitions', [
			&$typeDefinitions
		] );
